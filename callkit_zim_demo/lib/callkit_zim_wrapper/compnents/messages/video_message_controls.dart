...
class ZIMWrapperCustomControls extends StatefulWidget {
  const ZIMWrapperCustomControls({
  ...
  State<StatefulWidget> createState() {
    return ZIMWrapperCustompControlsState();
  }
}

class ZIMWrapperCustompControlsState extends State<ZIMWrapperCustomControls> with SingleTickerProviderStateMixin {
  ...
  Widget _buildHitArea() {
    ...
    final showPlayButton = widget.showPlayButton && !_dragging && !notifier.hideStuff;
